package alexey.gritsenko.playlistmaker.ui.search.view_model
...
class SearchViewModel(
    ...
    fun findTrack(searchString: String) {
        ...
        showMode.postValue(SHOW_PROGRESS_BAR)
        tracksSearchStore = searchTrackUseCase.execute(searchString) { status ->
            when (status) {
                OK -> {
